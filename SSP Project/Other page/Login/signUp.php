...
<?php
  ...
  if(!empty($_POST)){
    ...
    if($flag){
      ...
      $signUpQuery = $conn -> query("INSERT INTO accounts (`id`,`username`,`password`,`securityQ`,`privilege`)  VALUES ('$id','$username','$password','$securityQ','partial') ");
    ...
    <div class="row">
      ...
      <form class="px-4 py-3 col-md-4 needs-validation" novalidate method="post" >
        ...
        <div class="form-group">
          ...
          <div class="invalid-feedback">
                Please enter your the name of your first pet or your favorite pet.
          </div>
        </div>
